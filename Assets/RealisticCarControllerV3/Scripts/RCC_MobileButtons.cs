...
public class RCC_MobileButtons : RCC_Core
{
    ...
    [SerializeField] Transform gearBtnHandle;
    ...
    public void ToggleGear(bool forward)
    {
        //if (forward)
            gearBtnHandle.localScale = new Vector3(gearBtnHandle.localScale.x, gearBtnHandle.localScale.y *-1f, gearBtnHandle.localScale.z);
        //else
        //    gearBtnHandle.localScale = new Vector3(1, 1, 1);
    }
    void DisableButtons()
    {
